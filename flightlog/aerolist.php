...
$aero = array (		// code OACI => FullName , geographic bounds, airfield altitude , password
	...
	'LZMA'=> array('MARTIN',"l.rec='LZMA' AND l.alt < 1120 AND (l.lat BETWEEN 49.05502 AND 49.08100 ) AND (l.lon BETWEEN 18.93922 AND 18.96368 )",420,''),
	...
	'LZTR'=> array('TRNAVA',"l.rec='LZTR' AND l.alt < 900 AND (l.lat BETWEEN 48.42179 AND 48.48600 ) AND (l.lon BETWEEN 17.50877 AND 17.56404 )",200,''),
